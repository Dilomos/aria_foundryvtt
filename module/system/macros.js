    ...
    static rollStatMacro = async function (actor, stat, onEnter = "submit") {
        if(actor){
            ...
            switch(stat){
                ...
                case "end" : statObj = eval(`actor.data.data.stats.end`); break;
            ...
            await AriaRoll.skillRollDialog(actor, game.i18n.localize(statObj.label), statObj.mod, 0, 20, statObj.superior, onEnter);
        } else {
